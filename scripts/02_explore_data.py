...
def top_words(df: pd.DataFrame, n: int = 10) -> None:
    ...
    stopwords = {
        "i", "a", "the", "to", "and", "is", "in", "it", "of", "you",
        "my", "me", "we", "he", "she", "are", "be", "was", "for",
        "on", "that", "this", "with", "do", "have", "your", "but",
        "not", "at", "or", "from", "an", "as", "so", "if", "up",
        "its", "no", "by", "had", "has", "all", "any", "there",
    }
